package org.siemac.metamac.sdmx.srm.rest.external.v2_1.service;
...
public abstract class SdmxRestExternalFacadeV21BaseTest extends MetamacRestBaseTest {
    ...
    private static String                       jaxrsServerAddress = "http://localhost:" + ServerResource.PORT + "/apis/sdmx/structural-resources";
    protected String                            baseApi            = jaxrsServerAddress + "/v2.1";
    protected static ApplicationContext         applicationContext = null;
    private static SdmxDataRestExternalFacadeV21 sdmxSrmRestExternalFacadeClientXml;
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        // xml
        {
            ...
            sdmxSrmRestExternalFacadeClientXml = JAXRSClientFactory.create(jaxrsServerAddress, SdmxDataRestExternalFacadeV21.class, providers, Boolean.TRUE);
        }
    }
    ...
    protected SdmxDataRestExternalFacadeV21 getSdmxSrmRestExternalFacadeClientXml() {
        WebClient.client(sdmxSrmRestExternalFacadeClientXml).reset();
        WebClient.client(sdmxSrmRestExternalFacadeClientXml).accept(APPLICATION_XML);
        return sdmxSrmRestExternalFacadeClientXml;
    }
