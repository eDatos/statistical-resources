...
public class StatisticalResourcePublicationDescriptorsForm extends GroupDynamicForm {
    ...
    public StatisticalResourcePublicationDescriptorsForm() {
         ...
         * ExternalItemListItem publisherContributor = new ExternalItemListItem(StatisticalResourceDS.PUBLISHER_CONTRIBUTOR, getConstants().siemacMetadataStatisticalResourcePublisherContributor(),
         * false);
