...
public class CollectionMetadataTabViewImpl extends ViewImpl implements CollectionMetadataTabView {

    private CollectionMetadataTabUiHandlers uiHandlers;
    ...
    @Inject
    public CollectionMetadataTabViewImpl() {
        panel = new VLayout();
        panel.setHeight100();
    ...
    @Override
    public void setUiHandlers(CollectionMetadataTabUiHandlers uiHandlers) {
