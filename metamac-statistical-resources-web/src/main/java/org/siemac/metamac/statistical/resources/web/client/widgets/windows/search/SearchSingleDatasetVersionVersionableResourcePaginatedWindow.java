...
public class SearchSingleDatasetVersionVersionableResourcePaginatedWindow extends SearchRelatedResourceBasePaginatedWindow<VersionableRelatedResourceDto, DatasetVersionWebCriteria> {

    private VersionableStatisticalResourceFilterBaseForm<DatasetVersionWebCriteria> filterForm;

    public SearchSingleDatasetVersionVersionableResourcePaginatedWindow(String title, int maxResults, SearchPaginatedAction<DatasetVersionWebCriteria> action) {
