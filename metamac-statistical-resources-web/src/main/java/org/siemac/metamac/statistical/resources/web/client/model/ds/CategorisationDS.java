...
public class CategorisationDS extends DataSource {

    public static final String ID         = "cat-id";
    public static final String CODE       = "cat-code";
    public static final String NAME       = "cat-name";
