...
import org.siemac.metamac.statistical.resources.core.lifecycle.serviceimpl.dataset.DatasetLifecycleServiceImpl;
import org.siemac.metamac.statistical.resources.core.lifecycle.serviceimpl.dataset.DatasetLifecycleServiceInvocationValidator;
 ...
 */
public class DatasetLifecycleServiceTest extends StatisticalResourcesBaseTest  {
    ...
    public void testSendToProductionValidation() throws Exception {
        ...
        verify(siemacLifecycleChecker,times(1)).checkSendToProductionValidation(any(SiemacMetadataStatisticalResource.class), anyString(), anyListOf(MetamacExceptionItem.class));
