...
public class AvroMapperUtils {
    ...
    public static void setConfiguratinService(ConfigurationService configurationService) {
    ...
    public static void setDatasetRepository(DatasetRepository repository) {
