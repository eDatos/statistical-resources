...
public class IdentifiableStatisticalResourceAvroMapperTest {
    ...
    public void testAvro2Do() {
        ...
        IdentifiableStatisticalResource actual = IdentifiableStatisticalResourceAvroMapper.avro2Do(source);
    ...
    public void testDo2Avro() {
        ...
        IdentifiableStatisticalResourceAvro actual = IdentifiableStatisticalResourceAvroMapper.do2Avro(source);
