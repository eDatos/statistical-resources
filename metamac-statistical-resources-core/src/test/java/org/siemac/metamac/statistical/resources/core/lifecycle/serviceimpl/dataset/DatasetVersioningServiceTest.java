...
import static org.siemac.metamac.statistical.resources.core.utils.mocks.factories.DatasetVersionMockFactory.DATASET_VERSION_103_MAXIMUM_MINOR_VERSION_REACHED;
...
public class DatasetVersioningServiceTest extends StatisticalResourcesBaseTest {
    ...
    @Test
    @MetamacMock(DATASET_VERSION_103_MAXIMUM_MINOR_VERSION_REACHED)
    public void testVersioningDatasetMaximumMinorVersionReached() throws Exception {
        DatasetVersion previousDatasetVersion = datasetVersionMockFactory.retrieveMock(DATASET_VERSION_103_MAXIMUM_MINOR_VERSION_REACHED);
