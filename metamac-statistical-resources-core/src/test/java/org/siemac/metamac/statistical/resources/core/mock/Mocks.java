...
public class Mocks {
    ...
    public static ConceptScheme mock_CROSS_DOMAIN_CONCEPTS() {
        ...
        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("COLL_METHOD", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=SDMX:CROSS_DOMAIN_CONCEPTS(1.0).COLL_METHOD", "Data Collection Method", "en",
        ...
        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("CONF_STATUS", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=SDMX:CROSS_DOMAIN_CONCEPTS(1.0).CONF_STATUS", "Confidentiality - status", "en",
        ...
        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("DECIMALS", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=SDMX:CROSS_DOMAIN_CONCEPTS(1.0).DECIMALS", "Decimals", "en",
                        SrmMockUtils.buildConceptRepresentation("urn:sdmx:org.sdmx.infomodel.codelist.Codelist=SDMX:CL_DECIMALS(1.0)")));

        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("FREQ", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=SDMX:CROSS_DOMAIN_CONCEPTS(1.0).FREQ", "Frequency", "en",
        ...
        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("OBS_STATUS", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=SDMX:CROSS_DOMAIN_CONCEPTS(1.0).OBS_STATUS", "Observation value", "en",
        ...
        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("TITLE", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=SDMX:CROSS_DOMAIN_CONCEPTS(1.0).TITLE", "Title", "en",
                        SrmMockUtils.buildConceptRepresentation(BasicComponentDataType.STRING)));

        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("UNIT_MULT", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=SDMX:CROSS_DOMAIN_CONCEPTS(1.0).UNIT_MULT", "Unit Multiplier", "en",
    ...
    public static ConceptScheme mock_ECB_CONCEPTS() {
        ...
        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("CURRENCY_DENOM", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=ECB:ECB_CONCEPTS(1.0).CURRENCY_DENOM", "Currency denominator", "en",
                        SrmMockUtils.buildConceptRepresentation("urn:sdmx:org.sdmx.infomodel.codelist.Codelist=ISO:CL_CURRENCY(1.0)")));

        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("EXR_VAR", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=ECB:ECB_CONCEPTS(1.0).EXR_VAR", "Series variation - EXR context", "en",
                        SrmMockUtils.buildConceptRepresentation("urn:sdmx:org.sdmx.infomodel.codelist.Codelist=ECB:CL_EXR_VAR(1.0)")));

        conceptScheme.getConcepts().add(
                SrmMockUtils.buildConcept("EXR_TYPE", "urn:sdmx:org.sdmx.infomodel.conceptscheme.Concept=ECB:ECB_CONCEPTS(1.0).EXR_TYPE", "Exchange rate type", "en",
