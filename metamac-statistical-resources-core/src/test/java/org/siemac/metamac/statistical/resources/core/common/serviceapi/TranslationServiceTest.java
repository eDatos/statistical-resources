...
public class TranslationServiceTest extends StatisticalResourcesBaseTest implements TranslationServiceTestBase {
    ...
    public void testRetrieveTimeTranslation() throws Exception {

        // REPORTING TIME PERIOD
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2000-A1");
            assertEquals("2000", title.get("es"));
            assertEquals("2000", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2001-S1");
            assertEquals("2001 Primer semestre", title.get("es"));
            assertEquals("2001 First semester", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2001-S2");
            assertEquals("2001 Segundo semestre", title.get("es"));
            assertEquals("2001 Second semester", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2002-T3");
            assertEquals("2002 Tercer trimestre", title.get("es"));
            assertEquals("2002 Third trimester", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2003-Q4");
            assertEquals("2003 Cuarto cuatrimestre", title.get("es"));
            assertEquals("2003 Fourth quarter", title.get("en"));
        }
        {
            // Without translate
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2003-Q1");
            assertEquals("2003-Q1", title.get("es"));
            assertEquals(null, title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2004-M05");
            assertEquals("05/2004", title.get("es"));
            assertEquals("05/2004", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2005-W52");
            assertEquals("2005 Semana 52", title.get("es"));
            assertEquals("2005 Week 52", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2006-D364");
        ...
        // DATETIME
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2013-07-24T08:21:52.519+01:00");
        ...
        // GREGORIAN TIME
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2013");
            assertEquals("2013", title.get("es"));
            assertEquals("2013", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2004Z");
            assertEquals("2004", title.get("es"));
            assertEquals("2004", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "-0045");
            assertEquals("-0045", title.get("es"));
            assertEquals("-0045", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2004-05:00");
            assertEquals("2004", title.get("es"));
            assertEquals("2004", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2013-10");
            assertEquals("10/2013", title.get("es"));
            assertEquals("10/2013", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2013-08-30");
            assertEquals("30/08/2013", title.get("es"));
            assertEquals("30/08/2013", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2013-08-30+02:00");
            assertEquals("30/08/2013", title.get("es"));
            assertEquals("30/08/2013", title.get("en"));
        }
        ...
        // TIME RANGES
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2013-07-24T13:21:52.519+01:00/P1M");
        ...
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "2013-07-24/P1M");
            assertEquals("24/07/2013 a 24/08/2013", title.get("es"));
            assertEquals("24/07/2013 to 24/08/2013", title.get("en"));
        }
        {
            Map<String, String> title = translationService.retrieveTimeTranslation(ctx, "1999-07-01T03:04:05.519+01:00/P1Y1M2D");
