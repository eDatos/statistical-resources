...
public class PublicationVersionSculptorCriteria2MetamacCriteriaMapperImpl implements PublicationVersionSculptorCriteria2MetamacCriteriaMapper {
    ...
    public MetamacCriteriaResult<PublicationVersionDto> pageResultToMetamacCriteriaResultPublicationVersion(PagedResult<PublicationVersion> source, Integer pageSize) throws MetamacException {
        MetamacCriteriaResult<PublicationVersionDto> target = new MetamacCriteriaResult<PublicationVersionDto>();
        target.setPaginatorResult(SculptorCriteria2MetamacCriteria.sculptorResultToMetamacCriteriaResult(source, pageSize));
        if (source.getValues() != null) {
            target.setResults(new ArrayList<PublicationVersionDto>());
