...
public class ServiceNoticeAction {
    ...
    public static final String RESOURCE_CANCEL_PRODUCTION_VALIDATION          = "notice_message.resources.action.cancel_production_validation";
    public static final String RESOURCE_CANCEL_DIFFUSION_VALIDATION           = "notice_message.resources.action.cancel_diffusion_validation";
