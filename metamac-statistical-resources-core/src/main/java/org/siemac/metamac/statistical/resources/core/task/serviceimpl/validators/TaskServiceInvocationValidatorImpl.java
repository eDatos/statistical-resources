...
public class TaskServiceInvocationValidatorImpl {
    ...
    public static void checkPlannifyImportationDataset(TaskInfoDatasetDto taskInfoDataset, List<MetamacExceptionItem> exceptions) throws MetamacException {
    ...
    public static void checkProcessImportationTask(TaskInfoDatasetDto taskInfoDataset, List<MetamacExceptionItem> exceptions) throws MetamacException {
        StatisticalResourcesValidationUtils.checkParameterRequired(taskInfoDataset, ServiceExceptionParameters.TASK_INFO_DATASET, exceptions);
