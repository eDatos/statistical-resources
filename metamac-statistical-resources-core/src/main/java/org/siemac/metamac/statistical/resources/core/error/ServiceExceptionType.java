...
public class ServiceExceptionType extends CommonServiceExceptionType {
    ...
    public static final CommonServiceExceptionType INVALID_DATA_SOURCE_TYPE_FOR_FILE_IMPORTATION = create("exception.resources.dataset.importation.invalid_data_source_type_for_file_importation");
    ...
    public static final CommonServiceExceptionType INVALID_TABLENAME_FOR_DATASET_VERSION = create("exception.resources.dataset.importation.invalid_tablename_for_dataset");
