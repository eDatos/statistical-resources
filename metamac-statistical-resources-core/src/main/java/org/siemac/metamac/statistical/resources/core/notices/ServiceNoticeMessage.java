...
public class ServiceNoticeMessage {
    ...
    public static final String RESOURCE_CANCEL_PRODUCTION_VALIDATION_OK = "notice_message.resources.action.cancel_production_validation.ok";
    public static final String RESOURCE_CANCEL_DIFFUSION_VALIDATION_OK  = "notice_message.resources.action.cancel_diffusion_validation.ok";
