...
public class StatisticalResourcesVersionUtils extends StatisticalResourcesVersionSharedUtils {
    ...
    public static NextVersion createNextVersion(HasLifecycle resource, VersionTypeEnum versionType) throws MetamacException {
        return createNextVersion(resource.getLifeCycleStatisticalResource().getVersionLogic(), versionType);
    }

    public static NextVersion createNextVersion(String olderVersion, VersionTypeEnum versionType) throws MetamacException {
        try {
