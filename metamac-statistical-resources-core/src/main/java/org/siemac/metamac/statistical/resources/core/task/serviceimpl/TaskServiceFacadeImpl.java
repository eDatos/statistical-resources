...
public class TaskServiceFacadeImpl extends TaskServiceFacadeImplBase {
    ...
    @Override
    public void markTaskAsFailed(ServiceContext ctx, String job, String datasetVersionId, String datasetId, Exception exception) throws MetamacException {
        taskservice.markTaskAsFailed(ctx, job, datasetVersionId, datasetId);
    }
