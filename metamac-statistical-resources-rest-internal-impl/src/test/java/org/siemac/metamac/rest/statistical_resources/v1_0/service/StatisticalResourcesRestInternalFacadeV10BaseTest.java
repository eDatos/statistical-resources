...
public abstract class StatisticalResourcesRestInternalFacadeV10BaseTest extends MetamacRestBaseTest {
    ...
    protected String getRetrieveResourceUri(String resourcePath, String agencyID, String resourceID, String version, String fields, String langs) throws Exception {
        ...
        uri = RestUtils.createLinkWithQueryParam(uri, StatisticalResourcesRestInternalConstants.PARAMETER_FIELDS, RestUtils.encodeParameter(fields));
        uri = RestUtils.createLinkWithQueryParam(uri, StatisticalResourcesRestInternalConstants.PARAMETER_LANGS, RestUtils.encodeParameter(langs));
        return uri;
    }
