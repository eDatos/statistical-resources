...
CREATE TABLE TB_MULTIDATASET_MD_CUBES (
  MD_CUBE_FK NUMBER(19) NOT NULL,
  MULTIDATASET_VERSION_FK NUMBER(19) NOT NULL
);
...
ALTER TABLE TB_MULTIDATASET_MD_CUBES ADD CONSTRAINT PK_TB_MULTIDATASET_MD_CUBES
	PRIMARY KEY (MD_CUBE_FK, MULTIDATASET_VERSION_FK)
;
...
ALTER TABLE TB_MULTIDATASETS
	ADD CONSTRAINT UQ_TB_MULTIDATASETS UNIQUE (ID)
;



ALTER TABLE TB_MULTIDATASETS_VERSIONS
	ADD CONSTRAINT UQ_TB_MULTIDATASETS_VERSIONS UNIQUE (ID)
;
...
ALTER TABLE TB_MD_CUBES
	ADD CONSTRAINT UQ_TB_MD_CUBES UNIQUE (ID)
;
...
ALTER TABLE TB_MULTIDATASET_MD_CUBES ADD CONSTRAINT FK_TB_MULTIDATASET_MD_CUBES_79
	FOREIGN KEY (MD_CUBE_FK) REFERENCES TB_MD_CUBES (ID) DEFERRABLE initially IMMEDIATE
;
ALTER TABLE TB_MULTIDATASET_MD_CUBES ADD CONSTRAINT FK_TB_MULTIDATASET_MD_CUBES_86
	FOREIGN KEY (MULTIDATASET_VERSION_FK) REFERENCES TB_MULTIDATASETS_VERSIONS (ID) DEFERRABLE initially IMMEDIATE
;
