...
ALTER TABLE TB_MDV_DATASETS ADD CONSTRAINT PK_TB_MDV_DATASETS
	PRIMARY KEY (DATASET_FK, MULTIDATASET_VERSION_FK)
;
...
ALTER TABLE TB_MDV_DATASETS ADD CONSTRAINT FK_TB_MDV_DATASETS_DATASET_FK
	FOREIGN KEY (DATASET_FK) REFERENCES TB_DATASETS (ID) DEFERRABLE initially IMMEDIATE
;
ALTER TABLE TB_MDV_DATASETS ADD CONSTRAINT FK_TB_MDV_DATASETS_MULTIDATA87
