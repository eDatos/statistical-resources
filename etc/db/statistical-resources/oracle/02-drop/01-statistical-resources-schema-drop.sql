...
DROP TABLE TB_MULTIDATASET_MD_CUBES CASCADE CONSTRAINTS PURGE;
...
DROP TABLE TB_MD_CUBES CASCADE CONSTRAINTS PURGE;

DROP TABLE TB_TEMP_CODES CASCADE CONSTRAINTS PURGE;

DROP TABLE TB_DIM_REPR_MAPPING CASCADE CONSTRAINTS PURGE;
...
DROP TABLE TB_MULTIDATASETS_VERSIONS CASCADE CONSTRAINTS PURGE;

DROP TABLE TB_MULTIDATASETS CASCADE CONSTRAINTS PURGE;
