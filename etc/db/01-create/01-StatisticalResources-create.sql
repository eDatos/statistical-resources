...
ALTER TABLE TB_STAT_RESOURCES
	ADD CONSTRAINT UQ_TB_STAT_RESOURCES UNIQUE (ID)
;



ALTER TABLE TB_DATASETS
	ADD CONSTRAINT UQ_TB_DATASETS UNIQUE (ID)
;



ALTER TABLE TB_LIS_STAT_OFFICIALITY
	ADD CONSTRAINT UQ_TB_LIS_STAT_OFFICIALITY UNIQUE (ID)
;



ALTER TABLE TB_DATASETS_VERSIONS
	ADD CONSTRAINT UQ_TB_DATASETS_VERSIONS UNIQUE (ID)
;



ALTER TABLE TB_PUBLICATIONS
	ADD CONSTRAINT UQ_TB_PUBLICATIONS UNIQUE (ID)
;



ALTER TABLE TB_PUBLICATIONS_VERSIONS
	ADD CONSTRAINT UQ_TB_PUBLICATIONS_VERSIONS UNIQUE (ID)
;



ALTER TABLE TB_QUERIES
	ADD CONSTRAINT UQ_TB_QUERIES UNIQUE (ID)
;



ALTER TABLE TB_QUERIES_VERSIONS
	ADD CONSTRAINT UQ_TB_QUERIES_VERSIONS UNIQUE (ID)
;
...
ALTER TABLE TB_VERSION_RATIONALE_TYPE
	ADD CONSTRAINT UQ_TB_VERSION_RATIONALE_TYPE UNIQUE (ID)
;




ALTER TABLE TB_ATTRIBUTE_VALUES
	ADD CONSTRAINT UQ_TB_ATTRIBUTE_VALUES UNIQUE (ID)
;



ALTER TABLE TB_CODE_DIMENSIONS
	ADD CONSTRAINT UQ_TB_CODE_DIMENSIONS UNIQUE (ID)
;



ALTER TABLE TB_DATASOURCES
	ADD CONSTRAINT UQ_TB_DATASOURCES UNIQUE (ID)
;



ALTER TABLE TB_TEMP_CODES
	ADD CONSTRAINT UQ_TB_TEMP_CODES UNIQUE (ID)
;



ALTER TABLE TB_CUBES
	ADD CONSTRAINT UQ_TB_CUBES UNIQUE (ID)
;



ALTER TABLE TB_ELEMENTS_LEVELS
	ADD CONSTRAINT UQ_TB_ELEMENTS_LEVELS UNIQUE (ID)
;



ALTER TABLE TB_CHAPTERS
	ADD CONSTRAINT UQ_TB_CHAPTERS UNIQUE (ID)
;
...
ALTER TABLE TB_RR_IS_PART_OF ADD CONSTRAINT FK_TB_RR_IS_PART_OF_IS_PART_79
	FOREIGN KEY (IS_PART_OF_FK) REFERENCES TB_RELATED_RESOURCES (ID) DEFERRABLE initially IMMEDIATE
;
...
ALTER TABLE TB_RR_IS_REQUIRED_BY ADD CONSTRAINT FK_TB_RR_IS_REQUIRED_BY_IS_R85
	FOREIGN KEY (IS_REQUIRED_BY_FK) REFERENCES TB_RELATED_RESOURCES (ID) DEFERRABLE initially IMMEDIATE
;
