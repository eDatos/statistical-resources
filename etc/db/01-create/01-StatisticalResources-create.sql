...
CREATE TABLE TB_STATISTICAL_RESOURCES (
  ...
  STATISTICAL_OPERATION NUMBER(19),
  STATISTICAL_OPERATION_INS17 NUMBER(19),
...
CREATE TABLE TB_DATASETS_VERSIONS (
  ID NUMBER(19) NOT NULL,
  GEOGRAPHIC_DIMENSION_CODE VARCHAR2(255),
  ...
  RELATED_DSD NUMBER(19),
  UPDATE_FREQUENCY NUMBER(19),
  BIBLIOGRAPHIC_CITATION NUMBER(19),
...
CREATE TABLE TB_SR_CONTRIBUTORS (
  ...
  TB_STATISTICAL_RESOURCES NUMBER(19) NOT NULL
);
...
ALTER TABLE TB_SR_REQUIRES ADD CONSTRAINT PK_TB_SR_REQUIRES
	PRIMARY KEY (REQUIRES_FK, TB_STATISTICAL_RESOURCES)
;
...
;
ALTER TABLE TB_DATASETS_VERSIONS ADD CONSTRAINT FK_TB_DATASETS_VERSIONS_RELA84
	FOREIGN KEY (RELATED_DSD) REFERENCES TB_EXTERNAL_ITEMS (ID)
;
ALTER TABLE TB_DATASETS_VERSIONS ADD CONSTRAINT FK_TB_DATASETS_VERSIONS_UPDA69
	FOREIGN KEY (UPDATE_FREQUENCY) REFERENCES TB_EXTERNAL_ITEMS (ID)
;
ALTER TABLE TB_DATASETS_VERSIONS ADD CONSTRAINT FK_TB_DATASETS_VERSIONS_BIBL86
	FOREIGN KEY (BIBLIOGRAPHIC_CITATION) REFERENCES TB_INTERNATIONAL_STRINGS (ID)
;
...
;
ALTER TABLE TB_SR_CONTRIBUTORS ADD CONSTRAINT FK_TB_SR_CONTRIBUTORS_TB_STA16
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
...
;
ALTER TABLE TB_SR_HAS_PART ADD CONSTRAINT FK_TB_SR_HAS_PART_TB_STATIST32
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
...
;
ALTER TABLE TB_SR_IS_PART_OF ADD CONSTRAINT FK_TB_SR_IS_PART_OF_TB_STATI62
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
...
;
ALTER TABLE TB_SR_IS_REQUIRED_BY ADD CONSTRAINT FK_TB_SR_IS_REQUIRED_BY_TB_S78
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
...
;
ALTER TABLE TB_SR_LANGUAGES ADD CONSTRAINT FK_TB_SR_LANGUAGES_TB_STATIS63
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
...
;
ALTER TABLE TB_SR_MEDIATORS ADD CONSTRAINT FK_TB_SR_MEDIATORS_TB_STATIS62
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
...
;
ALTER TABLE TB_SR_PUBLISHERS ADD CONSTRAINT FK_TB_SR_PUBLISHERS_TB_STATI41
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
...
ALTER TABLE TB_SR_PUB_CONTRIBUTORS ADD CONSTRAINT FK_TB_SR_PUB_CONTRIBUTORS_PU30
	FOREIGN KEY (PUBLISHER_FK) REFERENCES TB_EXTERNAL_ITEMS (ID)
;
ALTER TABLE TB_SR_PUB_CONTRIBUTORS ADD CONSTRAINT FK_TB_SR_PUB_CONTRIBUTORS_TB74
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
...
;
ALTER TABLE TB_SR_REQUIRES ADD CONSTRAINT FK_TB_SR_REQUIRES_TB_STATIST30
	FOREIGN KEY (TB_STATISTICAL_RESOURCES) REFERENCES TB_STATISTICAL_RESOURCES (ID)
;
