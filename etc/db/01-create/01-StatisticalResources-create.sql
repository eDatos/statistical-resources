...
CREATE TABLE TB_STAT_RESOURCES (
  ...
  COPYRIGHTED_DATE_TZ VARCHAR2(50 CHAR),
...
ALTER TABLE DATASET_TB_PUBLICATIONS_VER ADD CONSTRAINT FK_DATASET_TB_PUBLICATIONS_V06
	FOREIGN KEY (DATASET) REFERENCES TB_DATASETS_VERSIONS (ID) DEFERRABLE initially IMMEDIATE
;
ALTER TABLE DATASET_TB_PUBLICATIONS_VER ADD CONSTRAINT FK_DATASET_TB_PUBLICATIONS_V32
	FOREIGN KEY (TB_PUBLICATIONS_VERSIONS) REFERENCES TB_PUBLICATIONS_VERSIONS (ID) DEFERRABLE initially IMMEDIATE
;

  
ALTER TABLE TB_DV_GEOGRAPHIC_COVERAGE ADD CONSTRAINT FK_TB_DV_GEOGRAPHIC_COVERAGE41
	FOREIGN KEY (GEOGRAPHIC_COVERAGE_FK) REFERENCES TB_EXTERNAL_ITEMS (ID) DEFERRABLE initially IMMEDIATE
;
...
ALTER TABLE TB_DV_TEMPORAL_COVERAGE ADD CONSTRAINT FK_TB_DV_TEMPORAL_COVERAGE_T89
	FOREIGN KEY (TEMPORAL_COVERAGE_FK) REFERENCES TB_EXTERNAL_ITEMS (ID) DEFERRABLE initially IMMEDIATE
;
...
ALTER TABLE TB_EI_MEASURES ADD CONSTRAINT FK_TB_EI_MEASURES_MEASURE_FK
	FOREIGN KEY (MEASURE_FK) REFERENCES TB_EXTERNAL_ITEMS (ID) DEFERRABLE initially IMMEDIATE
;
...
ALTER TABLE TB_RR_REQUIRES ADD CONSTRAINT FK_TB_RR_REQUIRES_REQUIRES_FK
	FOREIGN KEY (REQUIRES_FK) REFERENCES TB_RELATED_RESOURCES (ID) DEFERRABLE initially IMMEDIATE
;
...
ALTER TABLE TB_STAT_RESOURCES ADD CONSTRAINT FK_TB_STAT_RESOURCES_RIGHTS_72
	FOREIGN KEY (RIGHTS_HOLDER_FK) REFERENCES TB_EXTERNAL_ITEMS (ID)  DEFERRABLE initially IMMEDIATE
;
ALTER TABLE TB_STAT_RESOURCES ADD CONSTRAINT FK_TB_STAT_RESOURCES_LICENSE17
	FOREIGN KEY (LICENSE_FK) REFERENCES TB_INTERNATIONAL_STRINGS (ID)  DEFERRABLE initially IMMEDIATE
;
