...
;
ALTER TABLE TB_STAT_RESOURCES ADD CONSTRAINT FK_TB_STAT_RESOURCES_STATIST21
	FOREIGN KEY (STATISTICAL_OPERATION) REFERENCES TB_EXTERNAL_ITEMS (ID)
;
ALTER TABLE TB_STAT_RESOURCES ADD CONSTRAINT FK_TB_STAT_RESOURCES_STATIST72
	FOREIGN KEY (STATISTICAL_OPERATION_INS17) REFERENCES TB_EXTERNAL_ITEMS (ID)
;
